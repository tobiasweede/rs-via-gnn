"""Training GCMC model on the Goodreads ata set by mini-batch sample.

adapted from: https://github.com/dmlc/dgl/tree/master/examples/pytorch/gcmc

Parameters to run:

--data_name=goodreads --train_optimizer=adam --use_one_hot_fea --minibatch_size=4096 --gcn_agg_accum=stack --train_max_epoch=30
...
def config():
    ...
    parser.add_argument('--gcn_agg_units', type=int, default=25)
